...
path = 'C:\Users\nehal\OneDrive\Desktop\Research ST'
file = np.loadtxt(path +"EDM-1.csv")


# #open csv files
# open('EDM-1.csv') as csvfile:
...
# fnames = FileNames("EDM-1.csv") #finds the relative path to each file
# Numberofolders = fnames // Length; #total number of folders
# csvName = "EDM-1.csv" #sets the default name of the csv
# csvLength = StringLength[csvName] #length of the csv file
# pathLength = StringLength[fnames[[#]]] & /@ 
#   Range@Numberofolders; (*length of the total path for\ each folder*)
